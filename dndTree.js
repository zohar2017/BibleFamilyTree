...
function draw_tree(error, treeData) {
    ...
    // A recursive 递归的 helper function for performing some setup by walking through all nodes
    ...
    function colorNode(d) {
        ...
        if (d.synthetic == true) {
            ...
            if (d.type == "Bible") {
                result = (d._children || d.children) ? "darkViolet" : "darkViolet";
            } else if (d.type == "Other") {
                result = (d._children || d.children) ? "orangered" : "orange";
            } else if (d.type == "Apoplexy") {
                result = (d._children || d.children) ? "yellowgreen" : "yellowgreen";
    ...
    function update(source) {
        ...
        nodeEnter.append("text")
            ...
            .attr("bibleref", function (d) {
                return d.Bibleref && d.Bibleref != "" ? d.Bibleref : "";
            })
            .attr("scriptRef", function (d) {
                return d.scription && d.scription != "" ? d.scription : "";
            })
